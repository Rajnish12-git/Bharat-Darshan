...
export default function CulturalPassportPage() {
  ...
  const upcomingBookings =
    bookings?.filter((b) => isFuture(new Date(b.visitDate))) || [];
  const pastBookings =
    bookings?.filter((b) => isPast(new Date(b.visitDate))) || [];
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                <h1 className="text-2xl sm:text-3xl font-bold font-headline">
                  {user?.isAnonymous
                    ? "Guest User"
                    : user?.displayName || "My Space"}
                </h1>
                <p className="text-muted-foreground">
                  {user?.isAnonymous
                    ? "Sign up to save your bookings."
                    : user?.email}
                </p>
              </div>
          ...
          <Card className="bg-destructive/10 border-destructive">
            <CardHeader>
              ...
              <CardDescription className="text-destructive/80">
                There was a problem retrieving your booking history. Please try
                again later.
              </CardDescription>
            </CardHeader>
          </Card>
                ...
                <Card className="text-center py-12 sm:py-16 bg-secondary/30 border-dashed">
                  <CardContent>
                    ...
                    <p className="text-muted-foreground mt-2 text-sm sm:text-base">
                      You have no future visits planned yet.
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              {pastBookings.length > 0 ? (
                ...
                <Card className="text-center py-12 sm:py-16 bg-secondary/30 border-dashed">
                  <CardContent>
                    ...
                    <p className="text-muted-foreground mt-2 text-sm sm:text-base">
                      Your past booking requests will appear here.
                    </p>
                  </CardContent>
                </Card>
              )}
