...
const getCategoryIcon = (category) => {
  if (
    ...
    category.toLowerCase().includes("theatre")
  ) {
...
export default function ArtFormsPage() {
  const highlight = {
    ...
    description:
      "India's artistic traditions are a breathtaking spectrum of color, rhythm, and profound expression. From the intricate brushstrokes of miniature paintings to the powerful storytelling of classical dance, and from the rustic charm of folk crafts to the spiritual depth of ritual arts, these forms are a living heritage. They are the threads that weave together the nation's diverse cultural, social, and spiritual identity, passed down through generations as a testament to unparalleled creativity and devotion.",
        ...
        <div className="container py-12 md:py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <Accordion type="single" collapsible className="w-full">
              {artForms.map((art) => {
                const artImage = PlaceHolderImages.find(
                  (img) => img.id === art.imageId,
                );
                return (
