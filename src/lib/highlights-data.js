    ...
    details: [
      {
        ...
        description:
          "A classical dance-drama from Kerala known for its elaborate makeup and costumes.",
      },
      {
        name: "Madhubani Painting",
        imageId: "art-madhubani",
        description:
          "A style of folk painting from Bihar characterized by its intricate geometric patterns.",
      },
      {
        name: "Blue Pottery",
        imageId: "art-blue-pottery",
        description:
          "A traditional craft of Jaipur using a quartz-based paste for a vibrant blue glaze.",
      },
      {
        name: "Warli Painting",
        imageId: "art-warli-painting",
        description:
          "Tribal art from Maharashtra that uses geometric shapes to depict scenes of daily life.",
      },
    ],
  },
  {
    ...
    details: [
      {
        ...
        description:
          "The festival of colors, a joyous celebration marking the arrival of spring.",
      },
      {
        name: "Durga Puja",
        imageId: "festival-durga-puja",
        description:
          "A ten-day festival in West Bengal honoring the goddess Durga with elaborate idols and cultural events.",
      },
      {
        name: "Pushkar Fair",
        imageId: "festival-pushkar-fair",
        description:
          "One of the world's largest camel fairs, a vibrant spectacle of culture, trade, and contests.",
      },
      {
        name: "Onam",
        imageId: "festival-onam",
        description:
          "A harvest festival in Kerala celebrated with floral carpets, grand feasts, and snake boat races.",
      },
    ],
  },
  {
    ...
    details: [
      {
        ...
        imageId: "art-sitar",
        description:
          "A plucked stringed instrument with a long neck and a gourd resonating chamber, central to Hindustani classical music.",
      },
      {
        name: "Tabla",
        imageId: "art-tabla",
        description:
          "A pair of small hand drums that form the rhythmic foundation of North Indian classical music.",
      },
      {
        name: "Flute (Bansuri)",
        imageId: "art-flute",
        description:
          "A side-blown flute made from a single shaft of bamboo, known for its soulful and evocative melodies.",
      },
      {
        name: "Sarod",
        imageId: "art-sarod",
        description:
          "A fretless stringed instrument known for its deep, weighty, and introspective sound.",
      },
    ],
  },
];
