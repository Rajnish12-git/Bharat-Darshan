      ...
      <div className="container">
        ...
        <div className="relative wrap overflow-hidden p-4 md:p-10 h-full">
          ...
          {timelineEvents.map((event, index) => (
            <div
              key={event.id}
              className={`mb-8 flex justify-between items-center w-full ${index % 2 === 0 ? "md:flex-row-reverse" : "flex-row"}`}
            >
              ...
              <div className="order-1 bg-card rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4 ml-4 md:ml-0">
                ...
                <p className="text-sm leading-snug tracking-wide text-muted-foreground text-opacity-100">
                  {event.description}
                </p>
              </div>
            </div>
