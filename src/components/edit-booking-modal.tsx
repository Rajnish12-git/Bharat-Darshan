...
export default function EditBookingModal({ booking, isOpen, onOpenChange }: EditBookingModalProps) {
  ...
  useEffect(() => {
    if (booking) {
      ...
      const monument = architecturalMarvels.find(m => m.name === booking.monumentName);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-headline">Edit Your Booking</DialogTitle>
          <DialogDescription>
            Modify the details for your visit to <span className="font-semibold text-primary">{booking.monumentName}</span>.
          </DialogDescription>
        </DialogHeader>
