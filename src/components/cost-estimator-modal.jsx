...
const CostCard = ({ icon, title, amount, description }) => (
...
export default function CostEstimatorModal({ children, destination }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      console.error(e);
      setError(
        "Sorry, I couldn't estimate the cost right now. Please try again later.",
      );
    } finally {
      setIsPending(false);
    }
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Get an AI-powered cost estimate for your trip to{" "}
        ...
        {isPending && !results && (
          <div className="flex flex-col items-center justify-center gap-4 py-8">
            ...
            <p className="text-muted-foreground">
              Calculating your trip expenses...
            </p>
            <p className="text-xs text-muted-foreground/80 text-center">
              This may take a moment. The AI is planning the best budget for
              you.
            </p>
          </div>
        )}
          ...
          <div className="space-y-6 pt-4">
            <Card className="bg-secondary/50">
              <CardHeader>
                ...
                <CardDescription>
                  Total Estimated Cost for a 2-day solo trip
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <p className="text-xs text-muted-foreground text-center pt-4">
              * All costs are estimates generated by AI and may vary. These are
              for a solo traveler on a budget-friendly trip.
            </p>
          </div>
        )}
      </DialogContent>
