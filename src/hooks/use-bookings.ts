...
import { collection, query, orderBy, addDoc, serverTimestamp, getFirestore, doc, updateDoc, deleteDoc } from 'firebase/firestore';
...
export async function updateBooking(bookingId: string, bookingData: Partial<NewBookingData>) {
    const auth = getAuth();
    const firestore = getFirestore();
